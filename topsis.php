...
<div class="col-md-12">
    ...
    <h4><b>Skor Ternormalisasi Terbobot</b></h4>
    <table class="table table-bordered" border="1">
        <th></th>
        <th>A1</th>
        <th>A2</th>
    ...
    <h4><b>Solusi Ideal Positif</b></h4>
    <table class="table table-bordered" border="1">
        <th></th>
        <th>C1</th>
        <th>C2</th>
    ...
    <h4><b>Solusi Ideal Negatif</b></h4>
    <table class="table table-bordered" border="1">
        <th></th>
        <th>C1</th>
        <th>C2</th>
    ...
    <h4><b>Jarak Solusi Ideal Positif</b></h4>
    <table class="table table-bordered" border="1">
        <th></th>
        <th>D1+</th>
        <th>D2+</th>
    ...
    ?>
    <!-- Jarak Solusi ideal positif----------------->    
    <h4><b>Jarak Solusi Ideal Negatif</b></h4>
    <table class="table table-bordered" border="1">
        <th></th>
        <th>D1-</th>
        <th>D2-</th>
    ...
    <h4><b>Skor Akhir Setiap Alternatif</b></h4>
    <table class="table table-bordered" border="1">
        <th></th>
        <th>V1</th>
        <th>V2</th>
